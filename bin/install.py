...
def create_dir():
    if (not os.path.exists("/Users/10002927/docker/cmdb/db")):
        base("sudo mkdir -p /Users/10002927/docker/cmdb/db")
    if (not os.path.exists("/Users/10002927/docker/cmdb/es")):
        base("sudo mkdir -p /Users/10002927/docker/cmdb/es")

def run_db_container():
    base("sudo docker run --name cmdb-db -d -e MYSQL_ROOT_PASSWORD=cmdbcmdb -v /Users/10002927/docker/cmdb/db:/var/lib/mysql mysql:5.7.21")

def run_es_container():
    base("sudo docker run --name cmdb-es -d -v /Users/10002927/docker/cmdb/es:/usr/share/elasticsearch/data elasticsearch:5.6.8")
